...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.MomentLikeResponse"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.TimeComment"
                                            }
                                        }
                                    }
                                }
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.TimeLike"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "model.MomentVisbileStatus": {
            ...
            "x-enum-varnames": [
                "MomentVisibleStatusPublic",
                "MomentVisibleStatusFriendsOnly",
                "MomentVisibleStatusSelfOnly",
                "MomentVisibleStatusPartialFriends"
            ]
        },
        ...
        "model.TimeLine": {
            ...
            "properties": {
                ...
                "owner_id": {
                    "description": "时间线发布者id",
                    "type": "integer"
                },
                "status": {
                    "description": "时间线状态，0-正常，1-删除,2-被举报中,3-举报成功,4-举报失败",
                    "type": "integer"
                },
                "updated_at": {
                    "description": "更新时间",
