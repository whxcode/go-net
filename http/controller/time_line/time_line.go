...
func GetTimeLines(c *gin.Context) *response.KResponse {
	return response.MakeResponse(dbTimeLine.GetTimeLines(utils.ParsePageQuery(c)))
}
...
func PostTimeLine(c *gin.Context) *response.KResponse {
	...
	return response.MakeResponse(dbTimeLine.PostTimeLines(data))
}
...
func PutTimeLine(c *gin.Context) *response.KResponse {
	...
	return response.MakeResponse(dbTimeLine.PutTimeLines(data))
}
...
func DeleteTimeLine(c *gin.Context) *response.KResponse {
	...
	return response.MakeResponse(dbTimeLine.DeleteTimeLines(data.ID, data.Status))
}
